import type { ParsedItem, ParsedTransaction } from '@/lib/csv-import/types'
...
export function parseAirregiCsvString(csvText: string): Record<string, string>[] {
...
export function groupAirregiTransactions(rows: Record<string, string>[]): {
