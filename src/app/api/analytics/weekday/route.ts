...
import { loadVendorWeekdayAnalyticsPayload } from '@/lib/vendor-analytics-loaders'
...
export async function GET(req: NextRequest) {
  ...
  try {
    return apiOk(await loadVendorWeekdayAnalyticsPayload(supabase, userId, scope, start, end))
  } catch (error) {
