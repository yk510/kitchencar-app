...
import { loadVendorTemperatureAnalyticsPayload } from '@/lib/vendor-analytics-loaders'
...
export async function GET(req: NextRequest) {
  ...
  try {
    return apiOk(await loadVendorTemperatureAnalyticsPayload(supabase, userId, scope, start, end))
  } catch (error) {
