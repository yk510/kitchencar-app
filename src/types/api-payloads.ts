...
export type EventApplicationRow =
  Database["public"]["Tables"]["event_applications"]["Row"];
...
export type VendorStoreRow =
  Database["public"]["Tables"]["vendor_stores"]["Row"];
export type StoreOrderPageRow =
  Database["public"]["Tables"]["store_order_pages"]["Row"];
export type StoreOrderScheduleRow =
  Database["public"]["Tables"]["store_order_schedules"]["Row"];
export type StoreOrderScheduleInventoryRow =
  Database["public"]["Tables"]["store_order_schedule_inventories"]["Row"];
export type MobileOrderInventoryAdjustmentRow =
  Database["public"]["Tables"]["mobile_order_inventory_adjustments"]["Row"];
export type MobileOrderInventoryStatus =
  ...
  | "low_stock"
  | "sold_out";
export type MobileOrderSource =
  Database["public"]["Tables"]["mobile_orders"]["Row"]["order_source"];
export type MobileOrderPaymentStatus =
  Database["public"]["Tables"]["mobile_orders"]["Row"]["payment_status"];
export type MobileOrderPaymentMethod = NonNullable<
  Database["public"]["Tables"]["mobile_orders"]["Row"]["payment_method"]
>;
export type StorePosPaymentMethod = Exclude<
  MobileOrderPaymentMethod,
  "card_online"
>;
...
export type NativeReceiptPrintOrigin =
  | "vendor_mobile_order_orders"
  | "store_pos"
  | "vendor_mobile_order_settings";
...
export type VendorMobileOrderSettingsUpdatePayload = Partial<
  VendorStorePosSettingsUpdatePayload & VendorReceiptPrintSettingsUpdatePayload
>;
...
export type MobileOrderProductRow =
  Database["public"]["Tables"]["mobile_order_products"]["Row"];
...
export type MobileOrderOptionGroupRow =
  Database["public"]["Tables"]["mobile_order_option_groups"]["Row"];
export type MobileOrderOptionChoiceRow =
  Database["public"]["Tables"]["mobile_order_option_choices"]["Row"];
...
export type VendorMobileOrderOptionGroupMutationPayload =
...
export type MobileOrderRow =
  Database["public"]["Tables"]["mobile_orders"]["Row"];
export type MobileOrderItemRow =
  Database["public"]["Tables"]["mobile_order_items"]["Row"];
export type MobileOrderItemOptionChoiceRow =
  Database["public"]["Tables"]["mobile_order_item_option_choices"]["Row"];
export type MobileOrderNotificationRow =
  Database["public"]["Tables"]["mobile_order_notifications"]["Row"];
...
export type VendorMobileOrderOrdersSummaryPayload =
  VendorMobileOrderOrdersPayload["counts"];
...
export type ReceiptPrintItemInput = {
  order_item_id: string;
  product_name: string;
  quantity: number;
  unit_price: number;
...
export type NativePrinterSettingsOpenRequest = {
